...
function bundledCafs(): string[] {
  const CAF_NAMES = ["astaghfirullah.caf", "athan_makkah.caf", "athan_madinah.caf", "athan_fajr.caf", "athan_ibn_majid.caf", "notif_bell.caf", "notif_chime.caf", "notif_alert.caf", "notif_calm.caf"];
  try {
