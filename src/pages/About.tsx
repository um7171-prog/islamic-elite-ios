...
import { Compass, Target, Eye, Sparkles, Download, BookOpen, Languages, Calculator, Bot, ScanText } from "lucide-react";
...
export default function About() {
  ...
  const services = [
    { to: "/media", Icon: Download, title: t("Smart Media Downloader", "تحميل الوسائط الذكي"), desc: t("Download videos from TikTok, YouTube, Instagram, Facebook and X.", "حمّل الفيديوهات من تيك توك ويوتيوب وإنستقرام وفيسبوك و X.") },
