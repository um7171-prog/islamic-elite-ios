    ...
    >
      ...
      <InfoCard icon={Bot} title={t("AI and media tools", "أدوات الذكاء والوسائط")}>
        <p>
          {t(
            iosNative
              ? "Translation, OCR, background removal and image enhancement rely on automated processing that can produce inaccurate output. Review important results before relying on them."
            ...
            iosNative
              ? "الترجمة واستخراج النصوص وإزالة الخلفية وتحسين الصور تعتمد على معالجة آلية قد تنتج مخرجات غير دقيقة، لذا راجع النتائج المهمة قبل الاعتماد عليها."
