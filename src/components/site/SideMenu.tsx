import { Menu, Home, LayoutGrid, Download, Bot, Music2, BookOpen, Settings as SettingsIcon, Info, Shield, FileText, Mail, Cookie, AlertTriangle, HelpCircle, Map } from "lucide-react";
  ...
  const groups: { title: string; items: { to: string; label: string; Icon: React.ElementType }[] }[] = [
    {
      ...
      items: [
        ...
        { to: "/tiktok", label: t("TikTok Analyzer", "تحليل حساب تيك توك"), Icon: Music2 },
