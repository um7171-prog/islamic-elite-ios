...
const SERVICES: Service[] = [
  ...
  { key: "jobs",    en: "Jobs",    ar: "وظائف السعودية", Icon: Briefcase, gradient: "linear-gradient(135deg, hsl(150 60% 30%), hsl(140 65% 42%))" },
...
export function QuickServices({ athanSettings, onAthanChange, scheduledCount, onReschedule, initialOpen = null }: Props) {
  ...
  const onTap = (s: Service) => {
    ...
    if (s.key === "jobs") { navigate("/saudi-jobs"); return; }
    setOpen(s.key);
  };
