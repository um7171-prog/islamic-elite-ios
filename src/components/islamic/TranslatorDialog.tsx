        ...
        <DialogContent dir={dir} className="max-w-3xl w-[96vw] h-[92vh] sm:h-[88vh] overflow-hidden flex flex-col p-4 sm:p-6">
          ...
          <div className="flex-1 overflow-y-auto space-y-3 pr-1">
            <textarea
              ...
              className="w-full rounded-xl border border-foreground/10 bg-white p-3 text-sm text-black placeholder:text-black/40 resize-none focus:outline-none focus:ring-1 focus:ring-elite-gold/60"
            />
            ...
            {imageDataUrl && (
              <div className="relative rounded-xl overflow-hidden border border-elite-gold/40 bg-black/20">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 h-7 w-7 grid place-items-center rounded-md bg-background/80 hover:bg-background border border-foreground/10"
                >
            ...
            <div className="relative">
              <textarea
                ...
                rows={5}
                className={`w-full rounded-xl border border-elite-gold/40 bg-white p-3 ${outputIsRtl ? "pl-12" : "pr-12"} text-sm text-black placeholder:text-black/40 resize-none`}
              />
              {output && (
                <button
                  type="button"
                  ...
                  className={`absolute top-2 ${outputIsRtl ? "left-2" : "right-2"} h-7 w-7 grid place-items-center rounded-md bg-background/70 hover:bg-background border border-foreground/10 transition`}
                >
                  {copied ? (
